  ...
  return (
    <Card className="p-6 mb-8">
      ...
      <div className="flex justify-center gap-6 mt-6 text-[10px] font-bold uppercase tracking-wider text-slate-500">
        <div className="flex items-center gap-2"><div className="w-3 h-3 bg-yellow-400 rounded-sm" /> Flash</div>
        <div className="flex items-center gap-2"><div className="w-3 h-3 bg-green-500 rounded-sm" /> Send</div>
        <div className="flex items-center gap-2"><div className="w-3 h-3 bg-slate-300 rounded-sm" /> Attempt</div>
      </div>
    </Card>
  );
}
